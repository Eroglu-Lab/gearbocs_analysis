---
title: "20240715_sparcl1_vglut2_P42_62_puncta_analyzer"
...
```{r load data}
data_combined <- read_csv("P42-65 V2.csv")
...
ggplot(plot.df, aes(x = condition, y = `mean(normalized_count)`)) + 
  ...
  labs(y = "Fold change in synapse number \n (colocalization of VGluT2 and PSD95)") +
  scale_color_manual(values = c("black", "black")) + theme(legend.position = "none") + 
  theme_bw()
  


# ggsave("sparcl1_vglut2_p42_62_puncta_analyzer_v2.pdf", width = 3, height = 4)
# ggsave("spracl1_vglut2_p42_62_puncta_analyzer_v2.png", width = 3, height = 4)
